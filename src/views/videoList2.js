...
class VideoList2 extends Component {
  ...
  componentDidUpdate(prevProps, prevState) {
    const { displayName, displayName2, displayName3, lastWeekStart } =
      this.state;
    const {
      user,
      exerciseVideo,
                    ...
                    <div className="">
                      <video
                        poster={
                          item.thumbnail
                            ? `${item.thumbnail}`
                            : `../assets/img/thumb/${item.category
                                .toLowerCase()
                                .split(" ")
                                .join("")}_g3.jpg`
                        }
                      ...
                      >
                        <source
                          src={
                            item.url
                              ? `${item.url}`
                              : `https://media.planforfit.com/bebe/video/${item.video_id}_720.mp4`
                          }
                          type="video/mp4"
                        ></source>
                      </video>
                      ...
                      {item.play_time !== item.duration &&
                        ...
                        member_info.program_level === "bfr_lv1" ? (
                          ...
                          >
                            ...
                            <div
                              className="randomVideoBtn mt-2 btn col-lg-12 col-md-4 col-12"
                              onClick={() =>
                                this.randomVideo(
                                  item.video_id,
                                  item.category,
              ...
              >
                ...
                <div>
                  ...
                  <select
                    id="playerDropdown"
                    name="player"
                    onChange={this.handlePlayerDropdownChange}
                  >
...
export default connect(mapStateToProps, mapActionsToProps)(VideoList2);
